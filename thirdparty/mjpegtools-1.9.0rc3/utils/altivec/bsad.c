/* bsad.c, this file is part of the
 ...
 *
 * {
 *     sum += abs( ((((pf[i]+pfa[i]+pfb[i]+pfc[i]+2)>>2)+
...
#define BSAD_ARGS pf, pb, p2, rowstride, hxf, hyf, hxb, hyb, h
...
ALTIVEC_TEST(bsad, int, (BSAD_PDECL),
