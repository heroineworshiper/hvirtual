...
/* Generated on Sat Jul  5 21:40:53 EDT 2003 */

#include "codelet-dft.h"

/* Generated by: /homee/stevenj/cvs/fftw3.0.1/genfft/gen_notw_noinline_c -simd -compact -variables 4 -n 16 -name m1fv_16 -include n1f.h */
...
static void m1fv_16_0(const R *xi, R *xo, stride is, stride os, int ivs, int ovs)
{
...
static void m1fv_16(const R *ri, const R *ii, R *ro, R *io, stride is, stride os, int v, int ivs, int ovs)
{
     int i;
     BEGIN_SIMD();
     for (i = 0; i < v; i += VL) {
	  m1fv_16_0(ri, ro, is, os, ivs, ovs);
	  ri += VL * ivs;
	  ro += VL * ovs;
     }
     END_SIMD();
...
static const kdft_desc desc = { 16, "m1fv_16", {68, 8, 4, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_m1fv_16) (planner *p) {
     X(kdft_register) (p, m1fv_16, &desc);
}
