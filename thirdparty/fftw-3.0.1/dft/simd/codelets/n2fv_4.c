...
/* Generated on Sat Jul  5 21:40:26 EDT 2003 */

#include "codelet-dft.h"

/* Generated by: /homee/stevenj/cvs/fftw3.0.1/genfft/gen_notw_c -simd -compact -variables 4 -n 4 -name n2fv_4 -with-ostride 2 -include n2f.h */
...
static void n2fv_4(const R *ri, const R *ii, R *ro, R *io, stride is, stride os, int v, int ivs, int ovs)
{
     ...
     for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs)) {
	  ...
	  ST(&(xo[2]), VSUB(T3, T6), ovs, &(xo[2]));
	  ST(&(xo[0]), VADD(T7, T8), ovs, &(xo[0]));
	  ST(&(xo[6]), VADD(T3, T6), ovs, &(xo[2]));
