...
/* Generated on Sat Jul  5 21:41:12 EDT 2003 */

#include "codelet-dft.h"

/* Generated by: /homee/stevenj/cvs/fftw3.0.1/genfft/gen_notw_noinline_c -simd -compact -variables 4 -n 32 -name m2fv_32 -with-ostride 2 -include n2f.h */
...
static void m2fv_32(const R *ri, const R *ii, R *ro, R *io, stride is, stride os, int v, int ivs, int ovs)
{
     int i;
     BEGIN_SIMD();
     for (i = 0; i < v; i += VL) {
	  m2fv_32_0(ri, ro, is, ivs, ovs);
	  ri += VL * ivs;
	  ro += VL * ovs;
     }
     END_SIMD();
...
static const kdft_desc desc = { 32, "m2fv_32", {170, 26, 16, 0}, &GENUS, 0, 2, 0, 0 };
void X(codelet_m2fv_32) (planner *p) {
     X(kdft_register) (p, m2fv_32, &desc);
}
