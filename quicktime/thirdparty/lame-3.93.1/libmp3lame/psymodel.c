...
/* $Id: psymodel.c,v 1.1.1.1 2003/10/14 07:54:37 heroine Exp $ */
 ...
 */
...

  {
    ...
    for(chn=0;chn<gfc->channels_out;chn++) {
      ...
      const sample_t * const firbuf = &buffer[chn][576-350-NSFIRLEN+576/3];
