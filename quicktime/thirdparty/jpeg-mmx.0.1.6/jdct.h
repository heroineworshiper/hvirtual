...
typedef short ISLOW_MULT_TYPE; /* short or int, whichever is faster (MUST be 16 bit for Intel MMX JPEG !) */
#if BITS_IN_JSAMPLE == 8
typedef short IFAST_MULT_TYPE; /* 16 bits is OK, use short if faster (MUST be 16 bit for Intel MMX JPEG !) */
